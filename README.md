...
| `startTransition`<br>(sync)                                    | ✅ **Prevents fallbacks** | Transitions work effectively during hydration and beyond                                                                                                                      | [test](src/tests/NoSuspenseTriggerOnTransitionUpdateComponent.test.tsx)<br>[test](src/tests/SuspenseTriggerOnDeferredValueComponent.test.tsx) |
