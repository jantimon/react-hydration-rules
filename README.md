...
| `startTransition`<br>(sync)                                    | ✅ **Prevents fallbacks** | Transitions work effectively during hydration and beyond                                                                                                                      | [test](src/tests/NoSuspenseTriggerOnTransitionUpdateComponent.test.tsx)                 |
